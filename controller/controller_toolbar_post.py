...
import scipy as sp
import numpy as np
from PyQt5.QtWidgets import QFileDialog, QLabel, QSizePolicy, QApplication, QMainWindow, QTableWidget, QTableWidgetItem, QVBoxLayout, QSlider, QWidget,QTextEdit, QTabWidget
