...
blkTime = 80 # us, blanking time of Barthel's RFPA
...
antenna_dict = {"RF01": np.pi/(0.5*110), "RF02": np.pi/(0.5*110)}
reference_time = 55  # us, reference excitation time to get the amplitude for rabi
fov = [20.0, 20.0, 20.0]
dfov = [0.0, 0.0, 0.0]
